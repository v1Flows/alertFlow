...
export default function HomeRunners() {
  ...
  const colors = ["#6020A0", "#6020A0", "#6366f1"];
  const sampleArcs = [
    {
      order: 1,
      startLat: -19.885592,
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 items-center gap-4">
        <div className="flex flex-row items-center justify-center md:h-auto dark:bg-black bg-white relative w-full">
          <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
            ...
            <div className="w-full -bottom-20 h-52 md:h-full z-10">
              {theme === "light" || isSSR ? (
                <World data={sampleArcs} globeConfig={lightGlobeConfig} />
              ) : (
                <World data={sampleArcs} globeConfig={darkGlobeConfig} />
              )}
            </div>
          </div>
        </div>
        <div className="flex flex-col items-center gap-4">
          <div className="flex flex-cols items-center gap-4">
            <div className="flex bg-secondary/20 text-secondary items-center rounded-medium justify-center w-14 h-14">
              <Icon icon="solar:globus-linear" width={38} />
            </div>
            <div className="text-start">
              <p className="font-bold text-xl">Connect from Everywhere</p>
              <p className="text-default-500 max-w-[500px]">
                Runners can be deployed on your own infrastructure, in the
                cloud, or even on your own machine. This way you can ensure that
                your actions are executed in the most secure and efficient way.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-cols items-center gap-4">
            ...
            <div className="text-start">
              ...
              <p className="text-default-500 max-w-[500px]">
                ...
                create your own plugins or use the ones that are already
          ...
          <div className="flex flex-cols items-center gap-4">
            ...
            <div className="text-start">
              ...
              <p className="text-default-500 max-w-[500px]">
                Different modes are available for runners depending on your
                need. They can only accept payload, execute flows, or both.
              </p>
            </div>
          </div>
        </div>
